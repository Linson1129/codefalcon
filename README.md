...
- **三级成本路由**：规则引擎 → Qwen-Turbo → DeepSeek-V3，按复杂度分配合适模型
...
│ DeepSeek-V3  │ Qwen-Turbo   │ DeepSeek-V3  │ Qwen-Turbo   │
└──────┬───────┴──────┬───────┴──────┬───────┴──────┬───────┘
       │              │              │              │
       └──────────────┴──────────────┴──────────────┘
                            │
...
│   │   ├── style_accept_agent.py    # Agent B: 风格 + 验收 (Qwen-Turbo)
│   │   ├── architect_agent.py       # Agent C: SOLID / 架构 (DeepSeek-V3)
│   │   └── spec_check_agent.py      # Agent D: 规范驱动审查 (Qwen-Turbo)
...
| 主力 LLM | DeepSeek-V3 | 性能强、成本低、中文友好，兼容 OpenAI SDK |
